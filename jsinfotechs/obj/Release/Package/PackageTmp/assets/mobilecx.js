...
$('#btnContactForm').click(function () {
    ...
    if (retval) {
        $.ajax({
            url: '../api/service/ContactEmailMR?name=' + $('#Custname').val() + '&email=' + $("#Custemail").val() + '&message=' + $("#msg").val() + '&GDPRStatus=' + $("input[name='progress']:checked").val(),
            type: 'POST',
            data: {},
